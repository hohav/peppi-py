...
from ._peppi import read_peppi as _read_peppi, read_slippi as _read_slippi, read_slippi_stream as _read_slippi_stream
...
def read_slippi_stream(path: str) -> None:
    read_slippi_stream(path)
